        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-8 ">
          ...
          <div className="flex-1 border-[3px] border-zinc-300 rounded-lg bg-gray-900 shadow-lg p-8">
            ...
            <p className="text-lg mb-8">
              Passionnée de développement d&apos;applications web et mobiles
              responsives.
            </p>
            <p className="text-lg mb-6">
              Je m&apos;efforce de créer des applications qui aident les
              utilisateurs de manière adaptée et efficace, tout en apportant des
              solutions innovantes.
            </p>
            <p className="text-lg mb-6">
              Vous pouvez consulter mon profil GitHub et LinkedIn en cliquant
