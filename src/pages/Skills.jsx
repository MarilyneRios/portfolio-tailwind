...
const Skills = () => {
  ...
  return (
    <div className="bg-sky-950 text-white py-20" id="skills">
      <div id="container" className="space-y-4">
        <div className="skills-container rounded">
          <div className="text-center">
            <h2 id="skills-title" className="text-3xl font-bold">Mes compétences</h2>
          </div>

          <div id="languages" className="text-center">
            <h4 className="text-2xl font-semibold my-5">Langages de programmation :</h4>
            <div 
              id="logosLanguages" 
              className="bg-gray-100 flex justify-center space-x-4 w-1/2 mx-auto p-4 rounded-lg"
            >
              <FaHtml5 size={50} style={{ color: "#F06529" }} />
              <FaCss3Alt size={50} style={{ color: "rgba(4, 93, 218, 0.5)" }} />
              <FaBootstrap size={50} style={{ color: "rgba(102, 16, 242, 0.5)" }} />
              <SiTailwindcss size={50} style={{ color: "rgba(0,116,199, 0.5)" }} />
              <SiJavascript size={50} style={{ color: "rgba(204, 204, 0, 0.9)" }} />
            </div>
          </div>

          <div id="Technologies" className="text-center mt-8">
            <h4 className="text-2xl font-semibold my-5">Outils et technologies :</h4>
